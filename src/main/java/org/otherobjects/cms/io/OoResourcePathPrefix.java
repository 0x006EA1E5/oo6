...
public enum OoResourcePathPrefix
{
    ...
    CORE("core", "otherobjects.resources"), STATIC("static", "site.resources/static"), SITE("site", "WEB-INF"), OTHEROBJECTS("otherobjects", "classpath:otherobjects.resources"), DATA("data", null), UPLOAD("upload", null);
