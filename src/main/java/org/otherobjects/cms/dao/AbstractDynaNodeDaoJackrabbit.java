...
public abstract class AbstractDynaNodeDaoJackrabbit extends GenericJcrDaoJackrabbit<DynaNode> implements DynaNodeDao
{
    ...
    public AbstractDynaNodeDaoJackrabbit()
    {
            ...
            public Object doInJcrMapping(ObjectContentManager manager) throws JcrMappingException
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        liveSession = AbstractDynaNodeDaoJackrabbit.this.sessionFactory.getSession(OtherObjectsJackrabbitSessionFactory.LIVE_WORKSPACE_NAME);
