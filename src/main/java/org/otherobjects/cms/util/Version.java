 ...
 * 
 * Note: Fixed warning in Eclipse and Checkstyle. (rich)
 */
@SuppressWarnings("unchecked")
public final class Version implements Comparable, Serializable
{
    private static final long serialVersionUID = 1037674554963377213L;
    ...
    public boolean complies(final Version other)
    {
        ...
        else if (mMinor == other.mMinor && mMicro < other.mMicro)
        {
