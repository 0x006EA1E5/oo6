...
SWFUpload.prototype._getFlashVars = function() {
	...
	sb.append("&JSESSIONID=" + readCookie('JSESSIONID'));
...
SWFUpload.prototype.loadUI = function() {
	...
	if(this.getSetting("target") != "" && this.getSetting("target") != "fileinputs") {
		...
		target.innerHTML = "";
		// RTA
		new Ext.Button(target,{text:'Select files...', icon:'/resources/otherobjects.resources/static/icons/add.png', cls:"x-btn-text-icon", handler:function() { instance.browse(); return false; }});
...
SWFUpload.prototype.addSetting = function(name, value, default_value) {
	// RTA Fix JS bug
	var val = (typeof(value) == "undefined" || value == null) ? default_value : value;
