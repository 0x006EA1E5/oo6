...
//import org.otherobjects.cms.dao.UniversalJcrDao;
...
//    {
//        super.onSetUp();
//        this.universalJcrDao = (UniversalJcrDao) getApplicationContext().getBean("universalJcrDao");
//        setupTypesService(this.typeService);
//        this.dynaNode = this.universalJcrDao.create(TEST_TYPE_NAME);
//        this.now = new Date();
...
//    {
//        DynaNode r = this.universalJcrDao.create("org.otherobjects.Dyna.jcr.TestReferenceObject");
//        r.setJcrPath("/" + name + ".html");
//        r.set("name", name + " Name");
//        this.universalJcrDao.save(r);
//        r = this.universalJcrDao.getByPath("/" + name + ".html");
//        return r;
//    }
//
//    protected DynaNode createComponent(String name)
//    {
//        DynaNode c = this.universalJcrDao.create("org.otherobjects.Dyna.jcr.TestComponentObject");
//        c.setCode(name);
