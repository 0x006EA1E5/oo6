...
public class FormatToolTest extends TestCase
{
    ...
    public void testFormatTextileStringBoolean()
    {
        String html = FormatTool.formatTextile("<i>test</i>", false);
        assertTrue(html.startsWith("<p><i>"));
        html = FormatTool.formatTextile("<i>test</i>", true);
    ...
    public void testBigDeanAllenTest()
    {
        ...
        String html = FormatTool.formatTextile(testInput, false);
