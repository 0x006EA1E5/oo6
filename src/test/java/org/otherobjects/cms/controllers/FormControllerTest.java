...
public class FormControllerTest extends TestCase
{
    ...
    public void testHandleRequest() throws Exception
    {
        ...
        formController.setTypeService(typeService);
        formController.setDaoService(daoService);
        formController.setBindService(new BindServiceImpl());
        ...
        formController.setValidatorService(validatorService);
        ...
        ModelAndView mav = formController.handleRequest(request, response);
        assertNull(mav);
    }
}
