 ...
 */
public class DynaNodeBeanWrapperImpl extends AbstractPropertyAccessor implements BeanWrapper {

    /**
     * We'll create a lot of these objects, so we don't want a new logger every time.
     */
    private static final Log logger = LogFactory.getLog(DynaNodeBeanWrapperImpl.class);
     ...
     */
    public DynaNodeBeanWrapperImpl() {
        this(true);
    }
     ...
     * @see #setWrappedInstance
     */
    public DynaNodeBeanWrapperImpl(boolean registerDefaultEditors) {
     ...
     */
    public DynaNodeBeanWrapperImpl(Object object) {
        registerDefaultEditors();
     ...
     */
    public DynaNodeBeanWrapperImpl(Class clazz) {
        registerDefaultEditors();
     ...
     */
    public DynaNodeBeanWrapperImpl(Object object, String nestedPath, Object rootObject) {
        registerDefaultEditors();
     ...
     */
    private DynaNodeBeanWrapperImpl(Object object, String nestedPath, DynaNodeBeanWrapperImpl superBw) {
    ...
    protected PropertyDescriptor getPropertyDescriptorInternal(String propertyName) throws BeansException {
        ...
        DynaNodeBeanWrapperImpl nestedBw = getBeanWrapperForPropertyPath(propertyName);
     ...
     */
    protected DynaNodeBeanWrapperImpl getBeanWrapperForPropertyPath(String propertyPath) {
        int pos = PropertyAccessorUtils.getFirstNestedPropertySeparatorIndex(propertyPath);
        // Handle nested properties recursively.
        if (pos > -1) {
            String nestedProperty = propertyPath.substring(0, pos);
            String nestedPath = propertyPath.substring(pos + 1);
            DynaNodeBeanWrapperImpl nestedBw = getNestedBeanWrapper(nestedProperty);
     ...
     */
    private DynaNodeBeanWrapperImpl getNestedBeanWrapper(String nestedProperty) {
        ...
        DynaNodeBeanWrapperImpl nestedBw = (DynaNodeBeanWrapperImpl) this.nestedBeanWrappers.get(canonicalName);
     ...
     */
    protected DynaNodeBeanWrapperImpl newNestedBeanWrapper(Object object, String nestedPath) {
        return new DynaNodeBeanWrapperImpl(object, nestedPath, this);
    }
    ...
    public void setPropertyValue(String propertyName, Object value) throws BeansException {
        DynaNodeBeanWrapperImpl nestedBw = null;
        try {
    ...
    private void setPropertyValue(PropertyTokenHolder tokens, PropertyValue pv) throws BeansException {
        ...
        ((DynaNode)this.object).set(propertyName, pv.getValue());
        return;
//        
//
//        if (tokens.keys != null) {
